            ...
            <div className="login-content">
                <div className="login-card">
                    <div className="login-header">
                        <div className="login-logo">
                            <svg className="login-logo-icon" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M12 2L2 7V12C2 16.97 5.75 21.56 12 23C18.25 21.56 22 16.97 22 12V7L12 2Z" fill="currentColor" opacity="0.3"/>
                        ...
                        <h1 className="login-title">TeleCare Express</h1>
                        <p className="login-subtitle">Client Portal Access</p>
                    </div>
                    ...
                    <div className="login-footer">
                        ...
                        <span>Secure connection • Client access only</span>
                    </div>
                </div>

                <div className="login-info">
                    <p>This is a protected mockup for client review. Please contact your account manager for access credentials.</p>
                </div>
            </div>
        </div>
    );
